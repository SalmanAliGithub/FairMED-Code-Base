...
class CreateRateAndReview(APIView):
    ...
    def post(self, request):
        ...
        '''
        form1 = CreatePhysicianReviewForm(request.POST)
        form2 = CreateHealthCenterReviewForm(request.POST)
        ...
        if form1.is_valid() and entity_type == 'physician':
            ...
            physicianId = request.POST.get('physician_id')
